...
@Component
@MappedAt(mapping = "/week_EKB")
public class WeekEKBAction implements Action{
    ...
    @Autowired
    public WeekEKBAction(RestTemplate restTemplate, WeatherConfig weatherConfig) {
    ...
    public String makeAction(double lat, double lon) {
        WeatherDTO dto = restTemplate.getForObject(weatherConfig.getUrl(),
                WeatherDTO.class, Location.EKATERINBURG.getLat(), Location.EKATERINBURG.getLon(), 7);
